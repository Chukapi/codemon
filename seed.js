...
const problems = [
  ...
  },
  {
    ...
    category: 'recursion',
    difficulty: 'easy',
    prompt: 'Write a function factorialNum that takes a number as an input and returns the factorial of that number',
  ...
  },
  {
    ...
    category: 'recursion',
    difficulty: 'easy',
    prompt: 'Write a function commonDivisor that takes two numbers as an input and returns  the greatest common divisor of both positive numbers.',
  ...
  },
  {
    ...
    category: 'recursion',
    difficulty: 'easy',
    prompt: 'Write a function exponentCalculator to compute the exponent of a number. Example: exponentCalculator(4,2) === 16.',
    tests: ['exponentCalculator(4,2) === 16']
  },
  {
    id: 9,
    category: 'recursion',
  ...
  },
  {
    ...
    category: 'recursion',
    difficulty: 'medium',
    prompt: 'Write a function binarySearch that takes a target number and a sorted array of numbers as input and returns the index of the target number. Example: binarySearch(5, [3,4,5,6,7,8,9,10]) === 2',
    tests: ['binarySearch(5, [3,4,5,6,7,8,9,10]) === 2']
  }
]
